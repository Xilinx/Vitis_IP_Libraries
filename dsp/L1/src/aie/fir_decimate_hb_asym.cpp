...
INLINE_DECL void kernelFilterClass<TT_DATA,
    ...
    // sendRtpTrigger(m_coeffnEq, outInterface);
    // if (m_coeffnEq) { // Coefficients have changed
    //     bufferReload<TT_DATA, TT_COEFF, (TP_FIR_LEN + 1) / 2 + 1, TP_DUAL_IP>(inInterface, m_oldInTaps,
    //     outInterface);
...
INLINE_DECL void kernelFilterClass<TT_DATA,
    ...
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize>* __restrict coeff =
        (::aie::vector<TT_COEFF, m_kCoeffRegVsize>*)m_internalTaps;
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize> coe0; // register for coeff values.
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize>* __restrict coeffCt =
        (::aie::vector<TT_COEFF, m_kCoeffRegVsize>*)m_internalTaps + internalCTIndex / m_kCoeffRegVsize;
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize> coeCt = *coeffCt; // register for coeff values.

    ::aie::vector<TT_DATA, m_kSamplesInDataBuff> sbuff;
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff> ph1Data, ph2Data;
    ...
    for (unsigned i = 0; i < m_kLsize; i++) chess_prepare_for_pipelining chess_loop_range(m_kLsize, ) {
            ...
            coeff = (::aie::vector<TT_COEFF, m_kCoeffRegVsize>*)m_internalTapsCopy;
            coe0 = *coeff;
...
INLINE_DECL void kernelFilterClass<TT_DATA,
    ...
    set_sat_mode<TP_SAT>();
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize>* __restrict coeff;
    coeff = (::aie::vector<TT_COEFF, m_kCoeffRegVsize>*)m_internalTaps;
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize> coe0; // register for coeff values.
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize>* __restrict coeffCt =
        (::aie::vector<TT_COEFF, m_kCoeffRegVsize>*)m_internalTaps + internalCTIndex / m_kCoeffRegVsize;
    ::aie::vector<TT_COEFF, m_kCoeffRegVsize> coeCt = *coeffCt; // register for coeff values.
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff>* ptr_delay =
        (::aie::vector<TT_DATA, m_kSamplesInDataBuff>*)delay;        // heap storage pointer
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff> sbuff = *ptr_delay; // initialize data register with data
                                                                     // allocated on heap which will contain
                                                                     // previous iterations margin samples.
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff> ph1Data, ph2Data;
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff>* ptr_ph1Data =
        (::aie::vector<TT_DATA, m_kSamplesInDataBuff>*)storePh1Data;
    ph1Data = *ptr_ph1Data;
    ::aie::vector<TT_DATA, m_kSamplesInDataBuff>* ptr_ph2Data =
        (::aie::vector<TT_DATA, m_kSamplesInDataBuff>*)storePh2Data;
    ph2Data = *ptr_ph2Data;
    T_acc384<TT_DATA, TT_COEFF> acc;
...
void fir_decimate_hb_asym<TT_DATA,
                          ...
                          TP_SAT>::filter(input_circular_buffer<TT_DATA,
                                          ...
                                          const TT_COEFF (&inTaps)[internalTapsSize]) {
    this->m_internalTaps = (TT_COEFF*)inTaps;
