...
INLINE_DECL void kernelFilterClass<TT_DATA,
    ...
    // isUpdateRequired = checkHeaderForUpdate<TP_API, TP_USE_COEFF_RELOAD, TP_CASC_IN, TT_DATA,
...
// FIR function - not needed anymore
//----------------------------------------------------------------------------------------------------------------------
template <typename TT_DATA,
          typename TT_COEFF,
          unsigned int TP_FIR_LEN,
...
void fir_sr_asym<TT_DATA,
    ...
    outInterface.outWindow = (output_circular_buffer<TT_DATA>*)&outWindow;
    this->m_internalTaps = (TT_COEFF*)inTaps;
    this->filterKernelRtp(inInterface, outInterface, inTaps);
};
