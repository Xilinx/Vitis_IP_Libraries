...
#undef _DSPLIB_FIR_RESAMPLER_HPP_DEBUG_
...
#pragma unroll(kDeciPhases)
                for (int dphase = 0; dphase < kDeciPhases; ++dphase) {
                    ...
                    chess_protect_access T_buff_256b<TT_COEFF>* coeff =
                        ((T_buff_256b<TT_COEFF>*)m_internalTaps /* m_internalTaps2 */ +
                         (dphase + iphase * kDeciPhases) * tapsArraySize / m_kCoeffRegVsize);
#else
                    chess_protect_access T_buff_256b<TT_COEFF>* coeff =
                        ((T_buff_256b<TT_COEFF>*)m_internalTaps /* m_internalTaps2 */ +
                         (decimate_asym::fnCoeffPhase(dphase, kDeciPhases) + iphase * kDeciPhases));
#endif
                ...
                for (int iphase = 0; iphase < kInterPhases; ++iphase) {
                    for (int dphase = 0; dphase < kDeciPhases; ++dphase) {
                        ...
                        if ((op) % m_kCoeffRegVsize == 0) {
                            ...
                            chess_protect_access T_buff_256b<TT_COEFF>* coeff =
                                ((T_buff_256b<TT_COEFF>*)m_internalTaps /* m_internalTaps2 */ +
                                 (coeOffset)*tapsArraySize / m_kCoeffRegVsize + (op / m_kCoeffRegVsize));
#else
                            chess_protect_access T_buff_256b<TT_COEFF>* coeff =
                                ((T_buff_256b<TT_COEFF>*)m_internalTaps /* m_internalTaps2 */ +
                                 (decimate_asym::fnCoeffPhase(dphase, kDeciPhases) + iphase * kDeciPhases) +
