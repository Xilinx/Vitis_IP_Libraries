...
INLINE_DECL constexpr unsigned int fnFirRangeAsym(unsigned int TP_FL,
                                                  unsigned int TP_CL,
                                                  int TP_KP,
                                                  unsigned int TP_API) {
...
template <typename TT_DATA, typename TT_COEFF>
INLINE_DECL constexpr unsigned int fnFirRangeRemAsym(unsigned int TP_FL,
                                                     unsigned int TP_CL,
                                                     int TP_KP,
                                                     unsigned int TP_API) {
    // TP_FL - FIR Length, TP_CL - Cascade Length, TP_KP - Kernel Position
...
INLINE_DECL constexpr unsigned int fnFirRangeAsym() {
    return fnFirRangeAsym<TT_DATA, TT_COEFF>(TP_FL, TP_CL, TP_KP,
                                             ((TP_API == 1) ? (fnStreamFirRangeRound<TT_DATA, TT_COEFF>()) : 1));
}
template <unsigned int TP_FL, unsigned int TP_CL, int TP_KP, typename TT_DATA, typename TT_COEFF, unsigned int TP_API>
INLINE_DECL constexpr unsigned int fnFirRangeRemAsym() {
    return fnFirRangeRemAsym<TT_DATA, TT_COEFF>(TP_FL, TP_CL, TP_KP,
                                                ((TP_API == 1) ? (fnStreamFirRangeRound<TT_DATA, TT_COEFF>()) : 1));
}
