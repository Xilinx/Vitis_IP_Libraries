...
INLINE_DECL constexpr int fnFirRange(unsigned int TP_FL, unsigned int TP_CL, int TP_KP, int TP_Rnd = 1) {
...
INLINE_DECL constexpr int fnFirRange() {
    return fnFirRange(TP_FL, TP_CL, TP_KP, TP_Rnd);
}
INLINE_DECL constexpr int fnFirRangeRem(unsigned int TP_FL, unsigned int TP_CL, int TP_KP, int TP_Rnd = 1) {
    // TP_FL - FIR Length, TP_CL - Cascade Length, TP_KP - Kernel Position
...
INLINE_DECL constexpr int fnFirRangeRem() {
    return fnFirRangeRem(TP_FL, TP_CL, TP_KP, TP_Rnd);
}
