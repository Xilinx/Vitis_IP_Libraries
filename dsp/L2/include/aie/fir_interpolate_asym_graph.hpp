...
class fir_interpolate_asym_graph : public graph {
   ...
   public:
    ...
    using rtp_port_array = port_conditional_array<input,
                                                  (TP_USE_COEFF_RELOAD == 1),
                                                  (TP_PARA_INTERP_POLY * TP_SSR * TP_SSR * TP_CASC_LEN)>;
    /**
    ...
    **/
    static constexpr unsigned int getTotalRtpPorts() {
        ...
        //
        return (TP_USE_COEFF_RELOAD == 0) ? 0 : (TP_CASC_LEN * TP_SSR * TP_SSR * TP_PARA_INTERP_POLY);
    };
