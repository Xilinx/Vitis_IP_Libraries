...
VSS_SCRIPT = vss_tb_cfg_gen_rtl_fft.py
else
...
gen_conn_cfg:
	$(VITIS_PYTHON3) $(DSPLIB_IP_ROOT_DIR)/L2/tests/vss/vss_fft_ifft_1d/${VSS_SCRIPT} --ssr $(SSR) --cfg_file_name system.cfg --vss_unit vss_fft_ifft_1d --freqhz $(FREQ) --aie_obj_name $(aie_name) --aie_variant $(AIE_VARIANT)
